  ...
  <div className="space-y-10">
    ...
    <div className="flex flex-col sm:flex-row sm:items-center border-l border-zinc-600 pl-6 gap-4 sm:gap-8 group">
      ...
      <div className="flex-shrink-0 self-start sm:self-center">
        <div className="flex items-center justify-center w-20 h-20 md:w-24 md:h-24 rounded-full bg-white p-3.5 border border-zinc-200/85 shadow-xl transition duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:border-white">
          <img
    ...
    {/* School */}
    <div className="flex flex-col sm:flex-row sm:items-center border-l border-zinc-600 pl-6 gap-4 sm:gap-8 group">
      {/* Left Details (Shrunk to content width) */}
      <div>
        <p className="text-sm tracking-[0.2em] uppercase text-zinc-500 mb-2">
          2019 — 2021
        </p>
...
>
  ...
  <div className="space-y-10">
    ...
    <div className="border-l border-zinc-600 pl-6">
      ...
      <h3 className="text-2xl text-zinc-100 font-medium">
        Research Intern
      </h3>
...
<div className="flex items-center gap-3 mt-3">
  ...
  <img
    src="/isro-logo2.png"
    alt="ISRO Logo"
    className="w-16 h-16 object-cover rounded-full border border-zinc-700 p-1 bg-zinc-800 ml-4 -mt-2"
  />
</div>
...
>
  {/* <h2
    className={`text-4xl md:text-4xl lg:text-5xl text-zinc-100 mb-14 tracking-wide ${mukta.className}`}
  >
    Projects
  </h2> */}
<h2
...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl">
    ...
    {/* Project Card 1 */}
<div className="group">
  <div className="relative rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-7 transition duration-300 hover:bg-white/15 hover:-translate-y-2 hover:border-white/20 shadow-xl">
    ...
    {/* <p className="text-sm tracking-[0.2em] text-zinc-500 mb-4">
      React.JS
    </p> */}
...
Santhe Connect is a smart tourism and local discovery platform that helps travelers find authentic weekly markets (Santhes), local eateries, and small hospitality businesses that are often not listed on major travel applications. The app provides an interactive map, 
GPS based location discovery, day wise Santhe filtering, user reviews, 
and AI generated descriptions to make local experiences more accessible and discoverable.
    </p>
...
<div className="group">
  <div className="relative rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-7 transition duration-300 hover:bg-white/15 hover:-translate-y-2 hover:border-white/20 shadow-xl">
    ...
    <p className="text-zinc-400 leading-8 text-[15px]">
StockStream-Pipeline is a Dockerized data engineering project that automates the collection, processing, and storage of stock market data using Apache Airflow. The pipeline orchestrates scheduled workflows to fetch stock information from external sources, store it in a database, and monitor execution through Airflow's web interface. By containerizing all services with Docker, 
the project ensures portability, scalability, and easy deployment.
    </p>
...
<div className="group">
  <div className="relative rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-7 transition duration-300 hover:bg-white/15 hover:-translate-y-2 hover:border-white/20 shadow-xl">
    ...
    <h3 className="text-2xl text-zinc-100 font-medium mb-4 group-hover:text-white transition duration-300">
      Machine Learning Approach for Plant Density 
Estimation 
    </h3>

    <p className="text-zinc-400 leading-8 text-[15px]">
Developed a machine learning system for plant density estimation using high-resolution satellite imagery. Converted RGB data to HSV color space for vegetation segmentation and evaluated multiple classification models. Support Vector Machine and 
Random Forest delivered the highest accuracy, enabling reliable crop monitoring and yield estimation.
  ...
  <div className="relative rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-7 transition duration-300 hover:bg-white/15 hover:-translate-y-2 hover:border-white/20 shadow-xl">
    ...
    <p className="text-zinc-400 leading-8 text-[15px]">
Built an AI-powered yoga posture detection web application that analyzes users' yoga poses in real time using computer vision and deep learning. 
The system leverages ResNet, PoseNet, MobileNet, and ResNet models to detect body keypoints, classify poses, and provide instant corrective feedback through an interactive web interface built with HTML, CSS, JavaScript, and Python.
    </p>
...
<div className="flex justify-center mt-8 translate-x-80">
  <a
